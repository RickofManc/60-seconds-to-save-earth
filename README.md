...
| ISS5 | Content small on 5K screens                      | Users who are playing the game on a 5K screen would not be able to see the content clearly as it is too small                        | style.css                            | 07/02/2022      |               | Media queries are being developed to ensure the game is playable on the largest screens. This fix will likely be scheduled for the next release.                                                                                         |
| ISS6 | Wind-turbine not rotating                        | The Wind-turbine icon used to swipe at the Power Stations is no longer rotating with each user click                                 | style.css and script.js              | 07/02/2022      |               | This issue is yet to be fully understood and resolved, a fix will be identified and scheduled for the next release.                                                                                                                      |
